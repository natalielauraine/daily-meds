...
const SECTIONS = [
  ...
  },
  {
    ...
    content: (
      <>
        ...
        <ul>
          <li><strong>Contractual Necessity:</strong> To provide our Service and fulfill our contract with you</li>
  ...
  },
  {
    ...
    content: (
      <>
        <p className="mb-4"><strong>We do not sell your personal data.</strong> We may share your information with:</p>
        <h3>5.1 Service Providers</h3>
        <p className="mb-4">Third-party vendors who help us operate our Service, including:</p>
        <ul>
  ...
  },
  {
    ...
    content: (
      <>
        <p className="mb-4">We retain your personal data for as long as necessary to provide our Service and fulfill the purposes described in this policy. Specifically:</p>
        <ul>
          <li><strong>Account data</strong> is retained while your account is active</li>
          <li><strong>Meditation history and progress data</strong> is retained to provide continuity</li>
          <li><strong>Payment records</strong> are retained as required by law (typically 7 years)</li>
          <li><strong>After account deletion</strong>, we retain minimal data for legal compliance and fraud prevention</li>
        </ul>
  ...
  },
  {
    ...
    title: "Do Not Track",
    content: (
      <p>Some browsers have a &ldquo;Do Not Track&rdquo; feature. We currently do not respond to Do Not Track signals, as there is no industry standard for interpreting them.</p>
    ),
  },
  {
    id: "dpo",
  ...
  },
  {
    ...
    title: "Contact Us",
    content: (
      <p>If you have questions about this Privacy Policy or how we handle your data, please contact us: Email: <a href="mailto:joy@dailymeds.com">joy@dailymeds.com</a></p>
    ),
  },
  {
    id: "consent",
