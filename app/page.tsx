...
const NEXT_RELEASE = [
  { title: "Guilty",    color: "#ff6a00", image: "https://uuglprtvwvumucnkrshj.supabase.co/storage/v1/object/public/share%20cards/1.png",          fallback: "linear-gradient(160deg, #1a0800 0%, #3d1500 100%)" },
