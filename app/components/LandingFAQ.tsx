...
const FAQS = [
  ...
  },
  {
    ...
    a: "We have a plan for everyone. Start completely free with 10 sessions, no card needed. The Listener is £9.99 a month — full audio library. The Seeker is £19.99 a month — audio plus live sessions with Natalie (coming soon). The Master is a one-time payment of £299.99 for lifetime access to everything, including all future content. Cancel anytime on monthly plans.",
  },
  {
